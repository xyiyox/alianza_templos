...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InformacionFinanciera.num_voluntarios'
        db.add_column(u'db_informacionfinanciera', 'num_voluntarios',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'InformacionFinanciera.desc_voluntarios'
        db.add_column(u'db_informacionfinanciera', 'desc_voluntarios',
                      self.gf('django.db.models.fields.TextField')(default='texto'),
                      keep_default=False)

        # Adding field 'InformacionFinanciera.dias_donados'
        db.add_column(u'db_informacionfinanciera', 'dias_donados',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Edificacion.ingeniero'
        db.add_column(u'db_edificacion', 'ingeniero',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ingeniero', null=True, to=orm['usuarios.Usuario']),
                      keep_default=False)

        # Adding field 'Edificacion.arquitecto'
        db.add_column(u'db_edificacion', 'arquitecto',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='arquitecto', null=True, to=orm['usuarios.Usuario']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InformacionFinanciera.num_voluntarios'
        db.delete_column(u'db_informacionfinanciera', 'num_voluntarios')

        # Deleting field 'InformacionFinanciera.desc_voluntarios'
        db.delete_column(u'db_informacionfinanciera', 'desc_voluntarios')

        # Deleting field 'InformacionFinanciera.dias_donados'
        db.delete_column(u'db_informacionfinanciera', 'dias_donados')

        # Deleting field 'Edificacion.ingeniero'
        db.delete_column(u'db_edificacion', 'ingeniero_id')

        # Deleting field 'Edificacion.arquitecto'
        db.delete_column(u'db_edificacion', 'arquitecto_id')
