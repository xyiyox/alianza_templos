...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Edificacion.dolar_moneda_local'
        db.alter_column(u'db_edificacion', 'dolar_moneda_local', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=3))

    def backwards(self, orm):

        # Changing field 'Edificacion.dolar_moneda_local'
        db.alter_column(u'db_edificacion', 'dolar_moneda_local', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=3))
    ...
    models = {
        ...
        u'db.edificacion': {
            ...
            'dolar_moneda_local': ('django.db.models.fields.DecimalField', [], {'max_digits': '8', 'decimal_places': '3'}),
