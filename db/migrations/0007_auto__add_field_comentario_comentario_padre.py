...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comentario.comentario_padre'
        db.add_column(u'db_comentario', 'comentario_padre',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['db.Comentario'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comentario.comentario_padre'
        db.delete_column(u'db_comentario', 'comentario_padre_id')
    ...
    models = {
        ...
        u'db.comentario': {
            ...
            'comentario_padre': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['db.Comentario']", 'null': 'True', 'blank': 'True'}),
