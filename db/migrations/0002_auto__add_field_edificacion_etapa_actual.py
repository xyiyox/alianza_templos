...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Edificacion.etapa_actual'
        db.add_column(u'db_edificacion', 'etapa_actual',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Edificacion.etapa_actual'
        db.delete_column(u'db_edificacion', 'etapa_actual')
