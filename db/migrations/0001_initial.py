    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comentario_padre', models.ForeignKey(blank=True, to='db.Comentario', null=True, on_delete=models.CASCADE)),
                ('commenter', models.ForeignKey(to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('arquitecto', models.ForeignKey(related_name='arquitecto', verbose_name=b'Arquitecto Asignado', blank=True, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.CASCADE)),
                ('ingeniero', models.ForeignKey(related_name='ingeniero', verbose_name=b'Ingeniero Asignado', blank=True, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.CASCADE)),
                ('usuario', models.ForeignKey(related_name='usuario', verbose_name=b'Responsable', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edificacion', models.OneToOneField(to='db.Edificacion', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(to='db.InformacionFinanciera', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='congregacion',
            name='edificacion',
            field=models.OneToOneField(to='db.Edificacion', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='condiciones',
            name='edificacion',
            field=models.ForeignKey(to='db.Edificacion', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
