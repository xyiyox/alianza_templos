...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comentario.created'
        db.add_column(u'db_comentario', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 10, 20, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comentario.created'
        db.delete_column(u'db_comentario', 'created')
