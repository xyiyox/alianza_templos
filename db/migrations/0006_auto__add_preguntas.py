...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'db_preguntas', (
            ...
            ('construccion1', self.gf('django.db.models.fields.BooleanField')()),
            ('construccion2', self.gf('django.db.models.fields.BooleanField')()),
            ('construccion3', self.gf('django.db.models.fields.BooleanField')()),
        ))
