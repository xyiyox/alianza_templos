...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'InformacionFinanciera.pago_fondo'
        db.delete_column(u'db_informacionfinanciera', 'pago_fondo')

        # Deleting field 'InformacionFinanciera.aporte_terreno'
        db.delete_column(u'db_informacionfinanciera', 'aporte_terreno')

        # Adding field 'InformacionFinanciera.valor_terreno'
        db.add_column(u'db_informacionfinanciera', 'valor_terreno',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=3),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'InformacionFinanciera.pago_fondo'
        db.add_column(u'db_informacionfinanciera', 'pago_fondo',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'InformacionFinanciera.aporte_terreno'
        db.add_column(u'db_informacionfinanciera', 'aporte_terreno',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=3),
                      keep_default=False)

        # Deleting field 'InformacionFinanciera.valor_terreno'
        db.delete_column(u'db_informacionfinanciera', 'valor_terreno')
