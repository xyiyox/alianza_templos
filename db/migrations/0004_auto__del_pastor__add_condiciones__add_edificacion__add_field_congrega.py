...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'db_edificacion', (
            ...
            ('congregacion', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['db.Congregacion'], unique=True)),
            ...
            ('dolar_moneda_local', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=3)),
            ...
            ('valor_solicitado_monedalocal', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=3)),
            ('valor_solicitado_dolares', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=3)),
            ('costo_total_monedalocal', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=3)),
            ('costo_total_dolares', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=3)),
            ('pago_fondo', self.gf('django.db.models.fields.SmallIntegerField')()),
        ))
        db.send_create_signal(u'db', ['Edificacion'])

        # Adding field 'Congregacion.nombre'
        db.add_column(u'db_congregacion', 'nombre',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2014, 5, 13, 0, 0), max_length=30),
                      keep_default=False)

        # Adding field 'Congregacion.nombre_pastor'
        db.add_column(u'db_congregacion', 'nombre_pastor',
                      self.gf('django.db.models.fields.CharField')(default=23, max_length=50),
                      keep_default=False)

        # Adding field 'Congregacion.entrenamiento_biblico'
        db.add_column(u'db_congregacion', 'entrenamiento_biblico',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=50),
                      keep_default=False)

        # Adding field 'Congregacion.estado_civil'
        db.add_column(u'db_congregacion', 'estado_civil',
        ...
        # Adding field 'Congregacion.titulos_obtenidos'
        db.add_column(u'db_congregacion', 'titulos_obtenidos',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=50),
                      keep_default=False)

        # Adding field 'Congregacion.anios_iglesia'
        db.add_column(u'db_congregacion', 'anios_iglesia',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Congregacion.anios_ministerio'
        db.add_column(u'db_congregacion', 'anios_ministerio',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Fuentes_Financieras.edificacion'
        db.add_column(u'db_fuentes_financieras', 'edificacion',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Congregacion.nombre'
        db.delete_column(u'db_congregacion', 'nombre')

        # Deleting field 'Congregacion.nombre_pastor'
        db.delete_column(u'db_congregacion', 'nombre_pastor')

        # Deleting field 'Congregacion.entrenamiento_biblico'
        db.delete_column(u'db_congregacion', 'entrenamiento_biblico')

        # Deleting field 'Congregacion.estado_civil'
        db.delete_column(u'db_congregacion', 'estado_civil')

        # Deleting field 'Congregacion.numero_hijos'
        db.delete_column(u'db_congregacion', 'numero_hijos')

        # Deleting field 'Congregacion.titulos_obtenidos'
        db.delete_column(u'db_congregacion', 'titulos_obtenidos')

        # Deleting field 'Congregacion.anios_iglesia'
        db.delete_column(u'db_congregacion', 'anios_iglesia')

        # Deleting field 'Congregacion.anios_ministerio'
        db.delete_column(u'db_congregacion', 'anios_ministerio')

        # Deleting field 'Fuentes_Financieras.edificacion'
        db.delete_column(u'db_fuentes_financieras', 'edificacion_id')
    ...
    models = {
        ...
        u'db.condiciones': {
            ...
            'proyecto': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'Condiciones_Edificacion'", 'symmetrical': 'False', 'to': u"orm['db.Edificacion']"})
        },
        u'db.congregacion': {
