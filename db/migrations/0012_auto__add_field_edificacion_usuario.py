...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Edificacion.usuario'
        db.add_column(u'db_edificacion', 'usuario',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['usuarios.Usuario']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Edificacion.usuario'
        db.delete_column(u'db_edificacion', 'usuario_id')
