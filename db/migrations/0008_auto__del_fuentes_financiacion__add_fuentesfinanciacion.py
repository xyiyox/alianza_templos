...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FuentesFinanciacion'
        db.create_table(u'db_fuentesfinanciacion', (
        ...
        db.send_create_signal(u'db', ['FuentesFinanciacion'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'FuentesFinanciacion'
        db.delete_table(u'db_fuentesfinanciacion')
    ...
    models = {
        ...
        u'db.fuentesfinanciacion': {
            'Meta': {'object_name': 'FuentesFinanciacion'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
